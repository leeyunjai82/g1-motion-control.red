...
if __name__ == '__main__':
    ...
    # 초기화(3초)가 끝난 후 명령 시작
    time.sleep(4) 
    custom.command_new_move(G1JointIndex.RightElbow, 40.0, 2.0)
    custom.command_new_move(G1JointIndex.RightShoulderYaw, 5.0, 2.0)
    custom.command_new_move(G1JointIndex.RightWristPitch, 5.0, 2.0)

    while True:
        print("오른쪽 어깨 관절을 2초에 걸쳐 움직입니다.")
        custom.command_new_move(G1JointIndex.RightShoulderPitch, -90.0, 1.0)
        custom.command_new_move(G1JointIndex.RightShoulderRoll, -50.0, 1.0)
        time.sleep(2)
        
        custom.command_new_move(G1JointIndex.RightElbow, -10.0, 0.8)
        time.sleep(1)
        custom.command_new_move(G1JointIndex.RightElbow, 10.0, 0.8)
        time.sleep(1)
        custom.command_new_move(G1JointIndex.RightElbow, -10.0, 0.8)
        time.sleep(1)
        custom.command_new_move(G1JointIndex.RightElbow, 40.0, 0.8)
        time.sleep(1)
        
        print("오른쪽 어깨 관절을 원위치로 2초에 걸쳐 움직입니다.")
        custom.command_new_move(G1JointIndex.RightShoulderPitch, 0.0, 1.0)
        custom.command_new_move(G1JointIndex.RightShoulderRoll, 0.0, 1.0)
        time.sleep(2)
